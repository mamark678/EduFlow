            ...
            <nav class="edu-nav">
                ...
                <div class="edu-nav-links" id="navLinks">
                    @auth
                        ...
                        <div class="edu-dropdown">
                            ...
                            <div id="notificationDropdown" class="edu-dropdown-menu notification-dropdown"
                                style="display: none;">
                                    ...
                                    @forelse($notifications as $notification)
                                        <a href="{{ route('notifications.show', $notification) }}"
                                            ...
                                            <div class="notification-content">
                                                ...
                                                <div class="notification-message">{{ Str::limit($notification->message, 60) }}
                                                </div>
                                ...
                                @if($notifications->count() > 0)
                                    <div class="notification-footer">
                                        <a href="{{ route('notifications.index') }}" class="view-all-notifications">View all
                                            notifications</a>
                                    </div>
                                @endif
                            </div>
                ...
                @auth
                    <div class="edu-dropdown ml-6">
                        <button class="edu-nav-link flex items-center gap-2" onclick="toggleDropdown()"
                            style="padding: 0.3rem 1rem;">
                            @if(Auth::user()->avatar)
                                <img src="{{ Auth::user()->avatar_url }}" alt="Avatar"
                                    class="w-9 h-9 rounded-full border-2 border-eduflow-teal shadow-sm object-cover transition-transform duration-200 hover:scale-105"
                                    style="background: #f1f5f9;" />
                            @else
                                <span
                                    class="w-9 h-9 rounded-full border-2 border-eduflow-teal shadow-sm flex items-center justify-center bg-gray-100 text-gray-400 text-xs font-bold select-none"
                                    style="background: #f1f5f9;">Avatar</span>
                            @endif
                            <span class="hidden sm:inline">{{ Auth::user()->name }}</span>
                            <span
                                class="edu-badge {{ Auth::user()->role === 'instructor' ? 'edu-badge-instructor' : 'edu-badge-student' }}">
                        ...
                        <div id="userDropdown" class="edu-dropdown-menu" style="display: none;">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="edu-dropdown-item"

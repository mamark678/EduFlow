...
class ForumController extends Controller
{
    public function index()
    {
        ...
        return view('admin.forums.index', compact('forums', 'totalPosts', 'totalComments', 'recentPosts'));
    }
    ...
    {
        // Cascade delete all posts and comments before deleting the forum
        ...
        $forum->delete();
        return redirect()->route('admin.forums.index')
            ->with('success', 'Forum and all its posts/comments deleted successfully!');
    }
    ...
    public function posts()
    {
        ...
        return view('admin.forums.posts', compact('posts'));
    }
    ...
    public function comments()
    {
        ...
        return view('admin.forums.comments', compact('comments'));
    }
